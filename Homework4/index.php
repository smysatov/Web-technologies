...
$profession = "manager"; 
$city = "Kampala";
$e_mail = "smysatov@gmail.com";
$phone_number = "+256757057928";
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i
            ...
            <div class="w3-container">
                <h5 class="w3-opacity"><b><?= $work_experience[$i]["title"]; ?></b></h5>
                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
                <?php if($i == 0):?>
                <?= $work_experience[$i]['start']; ?> - <span
                class="w3-tag w3-teal w3-round"><?= $work_experience[$i]['end']; ?></span></h6>
                <?php else:?>
                <?= $work_experience[$i]['start']; ?> - <?= $work_experience[$i]['end']; ?></h6>
                <?php endif;?>
